		...
		<div class="post-img-wrap">
			<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
				...
				if ( has_post_thumbnail() ) {
					...
					$azera_shop_placeholder_image = get_theme_mod('azera_shop_post_image_placeholder', azera_shop_get_file('/images/no-thumbnail.jpg'));
					if(!empty($azera_shop_placeholder_image)){ ?>
						<img src="<?php echo esc_url($azera_shop_placeholder_image); ?>" alt="<?php the_title_attribute(); ?>">
						<?php
					}
				} ?>
